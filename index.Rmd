...
* Code
    ...
    * Basic Data and Programming Structures
        * R script: [r2_data_and_programming_structures.R](r2_data_and_programming_structures.R)
        * R notebook: [![](colab-badge.svg)](https://colab.research.google.com/github/tdmdal/r-tutorial-202021-winter/blob/master/docs/rn2_Data_and_Programming_Structures.ipynb)
    * R Data Science
        * R script: [r3_data_manipulation_modelling_report_housing.R](r3_data_manipulation_modelling_report_housing.R)
        * Regression Report: [sample regression report](result.html) 
